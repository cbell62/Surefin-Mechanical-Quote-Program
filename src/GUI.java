...
public class GUI extends JFrame {
	...
	public GUI() {
		...
		txtCoil.setColumns(10);
				...
				comboBox_7 = new JComboBox(distributorC);
				contentPane.add(comboBox_7, "3, 32, fill, default");
				...
				comboBox_8 = new JComboBox(type);
				contentPane.add(comboBox_8, "3, 34, fill, default");
				...
				contentPane.add(textField_15, "6, 34, fill, default");
				...
				comboBox_9 = new JComboBox(size);
				contentPane.add(comboBox_9, "3, 36, fill, default");
				...
				contentPane.add(textField_16, "6, 36, fill, default");
				...
				comboBox_10 = new JComboBox(amount);
				contentPane.add(comboBox_10, "3, 38, fill, default");
