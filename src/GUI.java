...
public class GUI extends JFrame {
	...
	private Component silverpercentSolder;
	private Component materialofTubing;
	...
	public GUI() {
		...
		JComboBox typeofCoil = new JComboBox(option);
				...
				JComboBox sizeofConnection = new JComboBox(connectionSize);
			    ...
			    JComboBox materialofFrame = new JComboBox(frameMaterial);
			    ...
			    JComboBox materialofFin = new JComboBox(finMaterial);
				...
				JComboBox materialofTubing = new JComboBox(tubingMaterial);
				contentPane.add(materialofTubing, "3, 25, left, top");
				...
				JComboBox diameterofHeader = new JComboBox(headerDiameter);
				...
				JComboBox distributors = new JComboBox(distributorC);
				...
				JComboBox distributorType = new JComboBox(type);
				...
				JComboBox distributorSize = new JComboBox(size);
				...
				JComboBox distributorAmount = new JComboBox(amount);
